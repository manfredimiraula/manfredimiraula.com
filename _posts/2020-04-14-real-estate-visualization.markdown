...
img: 2020-04-14-real-estate-visualization/header.jpg # Add image post (optional)
tags: [Programming, Learn, data science, data visualization, visualization, investment, real estate, bokeh, plotly] # add tag
...
![Leinster region, distribution of house prices and number of transactions](assets/img/2020-04-14-real-estate-visualization/leinster_dist.jpg)*This image shows the distribution of house prices (left) and the number of transactions per year (right) in the Leinster region.*
...
![High-level summary using plotly](assets/img/2020-04-14-real-estate-visualization/summarize.jpg)*The image shows the trends of median sales price and number of transactions over the time period considered for all the regions in Ireland*
...
![Ireland in Bokeh](assets/img/2020-04-14-real-estate-visualization/ie.jpg)*Irish counties*
