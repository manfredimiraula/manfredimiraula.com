...
img: 2020-07-13-yet-another-python-installation-guide/instapic.png
fig-caption: # Add figcaption (optional)
tags: [post, blog, phd2datascience, data science, PhD, python, jupyter notebook, iTerm2, terminal]
...
![Vanilla iTerm](assets/img/2020-07-13-yet-another-python-installation-guide/vanilla.png)*The Vanilla version of iTerm2*

You will obtain a poweruser terminal similar to this

![Poweruser iTerm](assets/img/2020-07-13-yet-another-python-installation-guide/poweruser.png)*The poweruser version of iTerm2*
...
![Clean Python installation video tutorial](assets/img/2020-07-13-yet-another-python-installation-guide/myface.png)*[Video Tutorial][youtube]*
