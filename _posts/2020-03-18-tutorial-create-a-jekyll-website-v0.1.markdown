...
img: 2020-03-18-tutorial/jekyll.png # Add image post (optional)
tags: [front-end, jekyll, static-website, web-development, programming] # add tag
---
...
```
 ...
 ![Git installed response](/assets/img/2020-03-18-tutorial/git-response.png)*This is part of the response when git is installed*

  ![Gem installed response](/assets/img/2020-03-18-tutorial/gem-response.png)*This is part of the response when git is installed*
...
![Our Home MVP!](/assets/img/2020-03-18-tutorial/home.png)*Congrats! This is your first website Home page!*
