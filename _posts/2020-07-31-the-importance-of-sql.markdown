...
To help others that are in the process of learning SQL to understand the language faster, I started a series of lessons to *explain SQL in plain English*. You can find the first lesson on my YouTube channel, [here][video]
