...
![Our hero starts the quest](assets/img/2020-09-28-becoming-a-sql-database-administrator/quest_start.jpg)*Quest starts...*


**Our goal is to become a SQL database administrator!**
This set up the context and where my quest started. I wanted to create my own internal SQL database on my local machine, so that I could handle data faster and with a flow that resemble the one you would generally use in a proper business setting. 
...
**Preliminary steps**
We want, of course, to have some data at hand. This process is probaly worth it when you have to deal with a lot of data (many MegaBytes or Gigabytes of data), however you can test the process with a small sample. 
...
![Flow diagram](assets/img/2020-09-28-becoming-a-sql-database-administrator/flow_0.png)*The flow representation of the steps we want to accomplish*

**Step 1 and 2: Install Postgres, create user with the right privileges and create the database**

To install Postgres we can use brew (If you don't know brew, you can read how to install Brew and Python in one of my previous tutorial [here][prev_tutorial]). 
...
You should see now the new user in listed and their attributes. Your user should have no Attributes right now, which is normal. We are going to give them to it now. 
***Run***
```bash
...
<br>
![Flow diagram](assets/img/2020-09-28-becoming-a-sql-database-administrator/flow_1.png)*Step 1 and 2 accomplished!*
<br>
...
We are close to succeed in our quest. Last step remaining is to copy the data 
***Run***
```bash
$postgres=> \copy [table_name] (col1, col2, ..., coln) from '~/path/of/file' delimiter '[csv_delimiter]' csv header;
```

You may have different requirements here, depending the format of your source file. [Here][datatype] you can find the different options you can use while copying the data. 
...
<br>
<p align="center">
  <img width="195" height="73" src="assets/img/2020-09-28-becoming-a-sql-database-administrator/rows_copied.png" >
  <div align="center" class="caption">Result of the COPY process</div>
</p>
<br>

A further verification step, we can query the table directly 
***Run***
```bash
...
<br>
![Flow diagram](assets/img/2020-09-28-becoming-a-sql-database-administrator/flow_2.png)*Step 3 and 4 accomplished!*
<br>
...
<br>
<p align="center">
  <img width="600" height="310" src="assets/img/2020-09-28-becoming-a-sql-database-administrator/success.jpg" >
...
Download the most recent stable version of the UI from PgAdmin [website][pgadmin] and install it. We are going to connect the database we created in few simple steps.

Once installed, open the app and it will start a new page in your browser

<br>
![PgAdmin first page](assets/img/2020-09-28-becoming-a-sql-database-administrator/pg_1.png)*This is how PgAdmin will present itself once you installed it and started the server*
<br>
...
<br>
<p align="center">
  <img width="493" height="538" src="assets/img/2020-09-28-becoming-a-sql-database-administrator/pg_2.png" >
...
<br>
<p align="center">
  <img width="493" height="538" src="assets/img/2020-09-28-becoming-a-sql-database-administrator/pg_3.png" >
...
<br>
![Inside PgAdmin](assets/img/2020-09-28-becoming-a-sql-database-administrator/pg_4.png)*Inside PgAdmin!*
<br>
